    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-left" style="margin-top: 60px;">
        ...
        <div class="col-lg-5 col-md-5 col-sm-12">
          <a href="" title="" data-toggle="modal" data-target="#uploadfilethesis" style="color:green;">| <i class="fa fa-cloud-upload"></i> Import File</a> |
        </div>
      </div>
      <div class="row">
          ...
          <div class="row icon-boxes" style="margin-top: 20px;">
            <div class="icon-box bg-transparent">
              <table class="table table-hover">
                <thead>
                  <tr class="table-info">
                    <th colspan="3" style="font-size: 14px;">งานตำรา / ผลงานวิจัย / งานสร้างสรรค์ / อื่น ๆ</th>
                  </tr>
                </thead>
                <tbody>
                  <?php
...
<?php include 'add/uploadfilethesis.php'; ?>