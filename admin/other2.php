          ...
          <div class="row icon-boxes" style="margin-top: 20px;">
            <div class="icon-box bg-transparent">
              <table class="table table-hover">
                <thead>
                  <tr class="table-info">
                    <th colspan="2" style="font-size: 14px;">การควบคุมวิทยานิพนธ์ / สารนิพนธ์ระดับปริญญาตรี</th>
                  </tr>
                </thead>
                <tbody>
                  <?php
              ...
              <table class="table table-hover">
                <thead>
                  <tr class="table-info">
                    <th colspan="2" style="font-size: 14px;">การควบคุมวิทยานิพนธ์ระดับบัญฑิตศึกษา</th>
                  </tr>
                </thead>
                <tbody>
                  <?php
              ...
              <table class="table table-hover">
                <thead>
                  <tr class="table-info">
                    <th colspan="2" style="font-size: 14px;">การค้นคว้าอิสระ (IS) บัญฑิตศึกษาระดับปริญญาโท</th>
                  </tr>
                </thead>
                <tbody>
                  <?php
              ...
              <div class="row icon-boxes" style="margin-top: 20px;">
                <div class="col-md-12">
                  <div class="icon-box">
                    ...
                    <h6><li> ผลงานวิจัย/ งานสร้างสรรค์/ งานตำรา/ อื่น ๆ ที่จัดส่งมายังคณะฯ ชื่อเรื่อง/ รายละเอียดเนื้อหา ต้องไม่ซ้ำ ถึงแม้จะตีพิมพ์คนละแห่ง</li></h6><br><hr>
                  </div>
                </div>
              </div>
        </div>
