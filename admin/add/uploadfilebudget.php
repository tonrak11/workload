<div class="modal fade" id="uploadfilebudget">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <!-- Modal Header -->
      <div class="modal-header bg-success">
        <h4 class="modal-title"><i class="fa fa-plus-circle"></i> เพิ่มชุดข้อมูลค่าสอนของอาจารย์พิเศษ</h4>
      ...
      <form action="add/uploadbudget.php" method="post" enctype="multipart/form-data">
        <div class="row p-2">
          <div class="col-9">
